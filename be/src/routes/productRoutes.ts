...
router.get('/search/:name', asyncHandler(productController.searchProductsByName.bind(productController)));
router.get('/:category/:id', asyncHandler(productController.getProductsByID.bind(productController)));
