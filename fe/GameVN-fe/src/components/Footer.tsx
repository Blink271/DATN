    ...
    <footer className="bg-white text-black px-8 py-10 border-t border-gray-200">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-1">
            <li>
              Mua hàng: <a href="tel:19005301" className="text-blue-600">1900.5301</a>
            </li>
            <li>
              Bảo hành: <a href="tel:19005325" className="text-blue-600">1900.5325</a>
            </li>
            <li>
              Khiếu nại: <a href="tel:18006173" className="text-blue-600">1800.6173</a>
            </li>
            <li>
              Email: <a href="mailto:cskh@gearvn.com" className="text-blue-600">cskh@gearvn.com</a>
            </li>
          </ul>
        </div>
      </div>
